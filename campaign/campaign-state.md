...
- **Current adventure:** **01 — Honour Among Thieves**, **Scene 4: the Sindalian station — COMBAT (the Chamax).** Away team (Shake, Brakk, Sal) in standard EVA vacc suits boarded the derelict to reach the Vargr survivor. Detected nothing alive but the one heat source; pressed past a dead castaway's "IT HEARS THE WARM" scrawl + an acid-dissolved suit. **Hidden predator (GM: a Hunter Chamax — Hits 39, Armour +3, acid 3D/bite 2D+2, Life Sense, Stealth 4) ambushed and pinned Shake.** Combat in progress, player to act.
- **Combat round 2:** Shake's stab MISSED (6 vs 8 — chitin too tough). Sal's wrench FAILED (5 vs 8 — no leverage in zero-G). Chamax bit Shake (10 vs 8, 3 dmg); Brakk hauled him off the pin. **Shake now: ~5 dmg cumulative (END ~3), suit breached in TWO places, venting fast — a hard clock (~1–2 min to incapacitation from vacuum/blood loss).** No longer pinned. The Chamax is **unhurt** and turning on the group. Shake's **snub pistol is hull-safe** (won't breach the station); Brakk's slug gun risks venting everyone. The witness is still unreached. **Player to act — urgent.**
- *(GM note — Chamax tactics: lairs in the few pressurised/warm zones; can only stay in vacuum ~6 min before taking 1D/round. The crew don't know this yet — the vacuum is the creature's weakness.)*
