...
- **Current adventure:** **Phase 2 — Building the Kingdom (sandbox).** Allies: **Torpol (Friendly)**, **Clarke (Friendly, held; owed a defence → Haven)**. Now **at Paal (0805), courting it** — a rich farm world with old Drinax ties + tech-hunger + willing to ally "as equals" (strong prospect). Open threads: defend Clarke (pact); GeDeCo rivalry; **a corsair warlord massing to sack Pourne** (a danger + the key to winning the Pourne fortress). Awaiting the player's Paal courting approach.
