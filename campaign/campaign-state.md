...
- **Last scene recap:** Held the *Harrier* off (fragile station); EVA'd a 3-man team across. The Chamax (which Krrsh's beacon lured here, away from his hiding spot) pounced the point man: **bit Shake — 2 dmg + a SUIT BREACH (venting in vacuum, leaking)**; acid at his faceplate, pinned to the deck. Brakk (slug pistol) and Sal (blade) poised but **gunfire risks breaching the derelict** (any missed 10+ hit vents the station — and the salvage + the witness with it). Shake wounded & leaking; the witness still unreached deeper in.
