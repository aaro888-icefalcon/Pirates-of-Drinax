...
- **Current adventure:** **01 — Honour Among Thieves**, **Scene 6: taking Miria.** Repairs greenlit at Kallos (running ~2 days): **J-drive full teardown** (will CLEAR the wayward DM−1 — ends misjump risk), **M-drive cutout fix**, **ventral turret rebuilt as a triple pulse-laser mount (forward arc)** — ~Cr150k spent (cash ~Cr285k; General Systems double-cost left unaddressed). Infiltrated Miria's Scrapheap nest **with surprise intact** (Shake/Sal/Brakk, disguised, 9 vs 8). She's on her grounded Fat Trader's bridge — machinegun on her lap, **cyberarm**, boarding armor; one rusted-open companionway = a kill-box if approached loud. **Player choosing how to take her** (want her alive/talking — Ferrik's hideout is in her head or her ship's nav logs).
